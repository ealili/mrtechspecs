...
export default class EditPhone extends Component {
  ...
  handleChange() {
    fetch(`http://localhost/api/phone/get_phone.php?id=${this.state.phoneid}`)
                ...
                <select name="Phone"
                  ...
                  </option>
                  {
                    this.state.phones.map(phone => {
                      if(phone.mname==this.manufacturer.value) {
                        return <option value={phone.id}
                                       name={phone.id}
                                       key={phone.id}
